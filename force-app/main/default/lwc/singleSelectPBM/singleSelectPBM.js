...
import findRecords from "@salesforce/apex/IntakeFormWebsiteSearchController.findPBMTypeRecords";
export default class SingleSelectPBM extends LightningElement {
  @track recordsList;  
  @track searchKey = "";  
  @api selectedValue;  
  ...
  onRecordSelection(event) {  
   console.log('record selected'+event.target.dataset.name);
