...
export default class CustomToast extends LightningElement {
    ...
    isCustomToastInitialized = false;

    renderedCallback() {

        if(this.showToastBar) {

            if(this.isStackProgramInitialized) {
                return;
            }
    
            this.isCustomToastInitialized = true;
    
            const element = this.template.querySelector('.slds-notify_container');
            ...
            style.innerText = `
            .slds-notify_container .slds-theme_error {
